...
public class ReadFeedTask extends AsyncTask<String, Void, List<CelebrityEntry>>{
	final static String TAG="ReadFeedTask";
	final String testURl="http://www.maxim.com/girls/girls-of-maxim/all?page=1";
	final String startTag="<div class=\"gallery-list\">";
	final String endTag="</ul></div>    </div>";
	final String start="<div class=\"field-content teaser-image\">";
	
	private ILoadFeedProvider<CelebrityEntry> mFeedProvider;
	private int page=0;
	public ReadFeedTask(ILoadFeedProvider<CelebrityEntry> provider,int page) {
		super();
		this.page=page;
